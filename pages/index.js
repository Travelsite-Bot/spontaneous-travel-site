      ...
      <div className="flex flex-wrap items-center gap-3 mb-4 text-sm">
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            onChange={(e) => {
              ...
              if (start && end) {
                setFlights((prev) =>
                  prev.filter((f) => {
                    const flightMins = new Date(f.departure_at).getHours() * 60 +
          ...
          <input
            ...
            onChange={(e) => {
              ...
              const start = document.querySelector("input[type=time]")?.value;
              if (start && end) {
                setFlights((prev) =>
                  prev.filter((f) => {
                    const flightMins = new Date(f.departure_at).getHours() * 60 +
        ...
        {!oneWay && (
          <div className="flex items-center gap-2">
            ...
            <input type="time" step="900" className="border rounded p-1" />
            <input type="time" step="900" className="border rounded p-1" />
          </div>
        )}
      </div>
